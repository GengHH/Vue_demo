<template>
  <div class="s-canvas" @click="changeImg">
    <canvas id="s-canvas" :width="contentWidth" :height="contentHeight" title="点击图片切换验证码"></canvas>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    changeImg() {
        this.identifyCode = commonUtils[RANDOM_IDENTIFY_CODE](false,4,4)
    }
  },
  watch: {
    identifyCode(a,b) {
